...
**/
private var _dirBufPool = ({} : stdgo.sync.Sync.Pool);
/**
...
/**
    ...
    // "i/o timeout"
**/
var errDeadlineExceeded = (null : Error);
/**
    // ErrProcessDone indicates a Process has finished.
    
    
**/
var errProcessDone = (null : Error);
/**
...
**/
private var _errWriteAtInAppendMode = (null : Error);
/**
...
**/
var stdin = new File(Sys.stdin(), null);
/**
    // Stdin, Stdout, and Stderr are open Files pointing to the standard input,
    // standard output, and standard error file descriptors.
    //
...
**/
var stdout = new File(null, Sys.stdout());
/**
    // Stdin, Stdout, and Stderr are open Files pointing to the standard input,
    // standard output, and standard error file descriptors.
    //
...
**/
var stderr = new File(null, Sys.stderr());
/**
    
    
    
**/
private var _errPatternHasSeparator = (null : Error);
/**
    // lstat is overridden in tests.
    
    
**/
private var _lstat = null;
/**
...
**/
var lstatP = (null : Ref<GoString -> { var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; }>);
/**
    
    
    
**/
var errWriteAtInAppendMode = (null : Error);
/**
    
    
    
**/
var testingForceReadDirLstat = (null : Pointer<Bool>);
/**
    
    
    
**/
var errPatternHasSeparator = (null : Error);
/**
...
**/
private final _blockSize = (0 : GoUInt64);
/**
...
**/
final pathSeparator = (0 : GoInt32);
/**
    
    
    // OS-specific path list separator
**/
final pathListSeparator = (0 : GoInt32);
/**
...
/**
    ...
    // d: is a directory
**/
final modeDir = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    ...
    // a: append-only
**/
final modeAppend = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
    ...
    // l: exclusive use
**/
final modeExclusive = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
...
**/
final modeTemporary = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
    ...
    // L: symbolic link
**/
final modeSymlink = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
    ...
    // D: device file
**/
final modeDevice = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
    ...
    // p: named pipe (FIFO)
**/
final modeNamedPipe = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
...
**/
final modeSocket = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
    ...
    // u: setuid
**/
final modeSetuid = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
    ...
    // g: setgid
**/
final modeSetgid = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
...
**/
final modeCharDevice = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
    ...
    // t: sticky
**/
final modeSticky = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
...
**/
final modeIrregular = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // Mask for the type bits. For regular files, none will be set.
    
    
**/
final modeType = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
    // The defined file mode bits are the most significant bits of the FileMode.
    // The nine least-significant bits are the standard Unix rwxrwxrwx permissions.
    // The values of these bits should be considered part of the public API and
...
**/
final modePerm = ((0 : GoUInt32) : stdgo.io.fs.Fs.FileMode);
/**
...
@:structInit @:private @:using(stdgo.os.Os.T_dirInfo_static_extension) class T_dirInfo {
    public var _buf : Ref<Slice<GoUInt8>> = (null : Ref<Slice<GoUInt8>>);
...
@:structInit @:using(stdgo.os.Os.Process_static_extension) class Process {
    ...
    public function new(?pid:GoInt, ?_handle:GoUIntptr, ?_isdone:stdgo.sync.atomic.Atomic.Bool_, ?_sigMu:stdgo.sync.Sync.RWMutex) {
...
**/
@:structInit @:private @:using(stdgo.os.Os.T_onlyWriter_static_extension) class T_onlyWriter {
    @:embedded
    ...
    public function __underlying__() return Go.toInterface(this);
    @:embedded
    public function write(_b:Slice<GoUInt8>):{ var _0 : GoInt; var _1 : Error; } return null;
    public function __copy__() {
...
@:structInit @:using(stdgo.os.Os.File_static_extension) class File {
    ...
    public function __underlying__() return Go.toInterface(this);
    @:embedded
    public function _close():Error return (null : Error);
    public function __copy__() {
...
@:keep @:allow(stdgo.os.Os.T__struct_0_asInterface) class T__struct_0_static_extension {
    @:embedded
    public static function _unlockSlow( __self__:T__struct_0, __0:GoInt32) null;
    @:embedded
    public static function _lockSlow( __self__:T__struct_0) null;
    @:embedded
    public static function unlock( __self__:T__struct_0) null;
    @:embedded
    public static function tryLock( __self__:T__struct_0):Bool return return false;
    @:embedded
    public static function lock( __self__:T__struct_0) null;
}
...
**/
private function _readInt(_b:Slice<GoByte>, _off:GoUIntptr, _size:GoUIntptr):{ var _0 : GoUInt64; var _1 : Bool; } throw "os._readInt is not yet implemented";
private function _readIntBE(_b:Slice<GoByte>, _size:GoUIntptr):GoUInt64 throw "os._readIntBE is not yet implemented";
private function _readIntLE(_b:Slice<GoByte>, _size:GoUIntptr):GoUInt64 throw "os._readIntLE is not yet implemented";
private function _direntIno(_buf:Slice<GoByte>):{ var _0 : GoUInt64; var _1 : Bool; } throw "os._direntIno is not yet implemented";
private function _direntReclen(_buf:Slice<GoByte>):{ var _0 : GoUInt64; var _1 : Bool; } throw "os._direntReclen is not yet implemented";
private function _direntNamlen(_buf:Slice<GoByte>):{ var _0 : GoUInt64; var _1 : Bool; } throw "os._direntNamlen is not yet implemented";
private function _direntType(_buf:Slice<GoByte>):FileMode throw "os._direntType is not yet implemented";
/**
...
**/
private function _isShellSpecialVar(_c:GoUInt8):Bool throw "os._isShellSpecialVar is not yet implemented";
/**
    // isAlphaNum reports whether the byte is an ASCII letter, number, or underscore.
**/
private function _isAlphaNum(_c:GoUInt8):Bool throw "os._isAlphaNum is not yet implemented";
/**
    // getShellName returns the name that begins the string and the number of bytes
    // consumed to extract it. If the name is enclosed in {}, it's part of a ${}
    // expansion and two more bytes are needed than the length of the name.
**/
private function _getShellName(_s:GoString):{ var _0 : GoString; var _1 : GoInt; } throw "os._getShellName is not yet implemented";
/**
...
private function _errNoDeadline():Error throw "os._errNoDeadline is not yet implemented";
/**
...
**/
private function _errDeadlineExceeded():Error throw "os._errDeadlineExceeded is not yet implemented";
/**
...
private function _underlyingErrorIs(_err:Error, _target:Error):Bool throw "os._underlyingErrorIs is not yet implemented";
/**
    // underlyingError returns the underlying error for known os error types.
**/
private function _underlyingError(_err:Error):Error throw "os._underlyingError is not yet implemented";
/**
    // wrapSyscallError takes an error and a syscall name. If the error is
    // a syscall.Errno, it wraps it in a os.SyscallError using the syscall name.
**/
private function _wrapSyscallError(_name:GoString, _err:Error):Error throw "os._wrapSyscallError is not yet implemented";
private function _newProcess(_pid:GoInt, _handle:GoUIntptr):Ref<Process> throw "os._newProcess is not yet implemented";
/**
...
**/
function findProcess(_pid:GoInt):{ var _0 : Ref<Process>; var _1 : Error; } throw "os.findProcess is not yet implemented";
/**
...
**/
function startProcess(_name:GoString, _argv:Slice<GoString>, _attr:Ref<ProcAttr>):{ var _0 : Ref<Process>; var _1 : Error; } throw "os.startProcess is not yet implemented";
private function _startProcess(_name:GoString, _argv:Slice<GoString>, _attr:Ref<ProcAttr>):{ var _0 : Ref<Process>; var _1 : Error; } throw "os._startProcess is not yet implemented";
private function _findProcess(_pid:GoInt):{ var _0 : Ref<Process>; var _1 : Error; } throw "os._findProcess is not yet implemented";
/**
...
private function _executable():{ var _0 : GoString; var _1 : Error; } throw "os._executable is not yet implemented";
/**
    // stringsTrimSuffix is the same as strings.TrimSuffix.
**/
private function _stringsTrimSuffix(_s:GoString, _suffix:GoString):GoString throw "os._stringsTrimSuffix is not yet implemented";
private function _genericReadFrom(_f:Ref<File>, _r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } throw "os._genericReadFrom is not yet implemented";
/**
...
**/
private function _setStickyBit(_name:GoString):Error throw "os._setStickyBit is not yet implemented";
/**
...
/**
    ...
    // If there is an error, it will be of type *PathError.
**/
function create(_name:GoString):{ var _0 : Ref<File>; var _1 : Error; } throw "os.create is not yet implemented";
/**
    ...
    // If there is an error, it will be of type *PathError.
**/
function openFile(_name:GoString, _flag:GoInt, _perm:FileMode):{ var _0 : Ref<File>; var _1 : Error; } throw "os.openFile is not yet implemented";
/**
...
**/
private function _fixCount(_n:GoInt, _err:Error):{ var _0 : GoInt; var _1 : Error; } throw "os._fixCount is not yet implemented";
/**
...
**/
private function _containsAny(_s:GoString, _chars:GoString):Bool throw "os._containsAny is not yet implemented";
/**
...
private function _sigpipe():Void throw "os._sigpipe is not yet implemented";
/**
    // syscallMode returns the syscall-specific mode bits from Go's portable mode bits.
**/
private function _syscallMode(_i:FileMode):GoUInt32 throw "os._syscallMode is not yet implemented";
/**
    // See docs in file.go:Chmod.
**/
private function _chmod(_name:GoString, _mode:FileMode):Error throw "os._chmod is not yet implemented";
/**
...
/**
    ...
    // an EINTR loop.
**/
private function _ignoringEINTR(_fn:() -> Error):Error throw "os._ignoringEINTR is not yet implemented";
/**
    // fixLongPath is a noop on non-Windows platforms.
**/
private function _fixLongPath(_path:GoString):GoString throw "os._fixLongPath is not yet implemented";
private function _rename(_oldname:GoString, _newname:GoString):Error throw "os._rename is not yet implemented";
/**
    ...
    // constraints apply.
**/
function newFile(_fd:GoUIntptr, _name:GoString):Ref<File> throw "os.newFile is not yet implemented";
/**
    // newFile is like NewFile, but if called from OpenFile or Pipe
    // (as passed in the kind parameter) it tries to add the file to
    // the runtime poller.
**/
private function _newFile(_fd:GoUIntptr, _name:GoString, _kind:T_newFileKind):Ref<File> throw "os._newFile is not yet implemented";
/**
    // epipecheck raises SIGPIPE if we get an EPIPE error on standard
    // output or standard error. See the SIGPIPE docs in os/signal, and
    // issue 11845.
**/
private function _epipecheck(_file:Ref<File>, _e:Error):Void throw "os._epipecheck is not yet implemented";
/**
    // openFileNolog is the Unix implementation of OpenFile.
    // Changes here should be reflected in openFdAt, if relevant.
**/
private function _openFileNolog(_name:GoString, _flag:GoInt, _perm:FileMode):{ var _0 : Ref<File>; var _1 : Error; } throw "os._openFileNolog is not yet implemented";
/**
...
private function _tempDir():GoString throw "os._tempDir is not yet implemented";
/**
...
private function _newUnixDirent(_parent:GoString, _name:GoString, _typ:FileMode):{ var _0 : DirEntry; var _1 : Error; } throw "os._newUnixDirent is not yet implemented";
/**
...
**/
private function _endsWithDot(_path:GoString):Bool throw "os._endsWithDot is not yet implemented";
/**
...
**/
private function _basename(_name:GoString):GoString throw "os._basename is not yet implemented";
/**
    // splitPath returns the base name and parent directory.
**/
private function _splitPath(_path:GoString):{ var _0 : GoString; var _1 : GoString; } throw "os._splitPath is not yet implemented";
private function _fixRootDirectory(_p:GoString):GoString throw "os._fixRootDirectory is not yet implemented";
/**
...
private function _runtime_beforeExit(_exitCode:GoInt):Void throw "os._runtime_beforeExit is not yet implemented";
private function _newRawConn(_file:Ref<File>):{ var _0 : Ref<T_rawConn>; var _1 : Error; } throw "os._newRawConn is not yet implemented";
private function _removeAll(_path:GoString):Error throw "os._removeAll is not yet implemented";
/**
...
private function _fillFileStatFromSys(_fs:Ref<T_fileStat>, _name:GoString):Void throw "os._fillFileStatFromSys is not yet implemented";
/**
    // For testing.
**/
private function _atime(_fi:FileInfo):stdgo.time.Time.Time throw "os._atime is not yet implemented";
/**
    // statNolog stats a file with no test logging.
**/
private function _statNolog(_name:GoString):{ var _0 : FileInfo; var _1 : Error; } throw "os._statNolog is not yet implemented";
/**
    // lstatNolog lstats a file with no test logging.
**/
private function _lstatNolog(_name:GoString):{ var _0 : FileInfo; var _1 : Error; } throw "os._lstatNolog is not yet implemented";
/**
    // itox converts val (an int) to a hexadecimal string.
**/
private function _itox(_val:GoInt):GoString throw "os._itox is not yet implemented";
/**
    // uitox converts val (a uint) to a hexadecimal string.
**/
private function _uitox(_val:GoUInt):GoString throw "os._uitox is not yet implemented";
/**
    // Hostname returns the host name reported by the kernel.
**/
function hostname():{ var _0 : GoString; var _1 : Error; } throw "os.hostname is not yet implemented";
private function _hostname():{ var _0 : GoString; var _1 : Error; } throw "os._hostname is not yet implemented";
/**
...
**/
private function _fastrand():GoUInt32 return Std.random(1) > 0 ? -Std.random(2147483647) - 1 : Std.random(2147483647);
private function _nextRandom():GoString throw "os._nextRandom is not yet implemented";
/**
...
**/
function createTemp(_dir:GoString, _pattern:GoString):{ var _0 : Ref<File>; var _1 : Error; } throw "os.createTemp is not yet implemented";
/**
    // prefixAndSuffix splits pattern by the last wildcard "*", if applicable,
    // returning prefix as the part before "*" and suffix as the part after "*".
**/
private function _prefixAndSuffix(_pattern:GoString):{ var _0 : GoString; var _1 : GoString; var _2 : Error; } throw "os._prefixAndSuffix is not yet implemented";
/**
...
private function _joinPath(_dir:GoString, _name:GoString):GoString throw "os._joinPath is not yet implemented";
/**
    // LastIndexByte from the strings package.
**/
private function _lastIndex(_s:GoString, _sep:GoByte):GoInt throw "os._lastIndex is not yet implemented";
/**
...
private function _sameFile(_fs1:Ref<T_fileStat>, _fs2:Ref<T_fileStat>):Bool throw "os._sameFile is not yet implemented";
@:keep var _ = {
        try {
            args = _runtime_args();
...
@:keep @:allow(stdgo.os.Os.T_dirInfo_asInterface) class T_dirInfo_static_extension {
    @:keep
    static public function _close( _d:Ref<T_dirInfo>):Void throw "os._close is not yet implemented";
}
...
@:keep @:allow(stdgo.os.Os.SyscallError_asInterface) class SyscallError_static_extension {
    ...
    **/
    @:keep
    static public function timeout( _e:Ref<SyscallError>):Bool throw "os.timeout is not yet implemented";
    @:keep
    static public function unwrap( _e:Ref<SyscallError>):Error throw "os.unwrap is not yet implemented";
    @:keep
    static public function error( _e:Ref<SyscallError>):GoString throw "os.error is not yet implemented";
}
...
@:keep @:allow(stdgo.os.Os.Process_asInterface) class Process_static_extension {
    ...
    **/
    @:keep
    static public function _blockUntilWaitable( _p:Ref<Process>):{ var _0 : Bool; var _1 : Error; } throw "os._blockUntilWaitable is not yet implemented";
    @:keep
    static public function _release( _p:Ref<Process>):Error throw "os._release is not yet implemented";
    @:keep
    static public function _signal( _p:Ref<Process>, _sig:Signal):Error throw "os._signal is not yet implemented";
    @:keep
    static public function _wait( _p:Ref<Process>):{ var _0 : Ref<ProcessState>; var _1 : Error; } throw "os._wait is not yet implemented";
    @:keep
    static public function _kill( _p:Ref<Process>):Error throw "os._kill is not yet implemented";
    /**
        // Signal sends a signal to the Process.
        // Sending Interrupt on Windows is not implemented.
    **/
    @:keep
    static public function signal( _p:Ref<Process>, _sig:Signal):Error throw "os.signal is not yet implemented";
    /**
        // Wait waits for the Process to exit, and then returns a
        // ProcessState describing its status and an error, if any.
        // Wait releases any resources associated with the Process.
    ...
    **/
    @:keep
    static public function wait_( _p:Ref<Process>):{ var _0 : Ref<ProcessState>; var _1 : Error; } throw "os.wait_ is not yet implemented";
    /**
        // Kill causes the Process to exit immediately. Kill does not wait until
        // the Process has actually exited. This only kills the Process itself,
        // not any other processes it may have started.
    **/
    @:keep
    static public function kill( _p:Ref<Process>):Error throw "os.kill is not yet implemented";
    /**
        // Release releases any resources associated with the Process p,
        // rendering it unusable in the future.
        // Release only needs to be called if Wait is not.
    **/
    @:keep
    static public function release( _p:Ref<Process>):Error throw "os.release is not yet implemented";
    @:keep
    static public function _done( _p:Ref<Process>):Bool throw "os._done is not yet implemented";
    @:keep
    static public function _setDone( _p:Ref<Process>):Void throw "os._setDone is not yet implemented";
}
...
@:keep @:allow(stdgo.os.Os.ProcessState_asInterface) class ProcessState_static_extension {
    @:keep
    static public function _systemTime( _p:Ref<ProcessState>):stdgo.time.Time.Duration throw "os._systemTime is not yet implemented";
    @:keep
    static public function _userTime( _p:Ref<ProcessState>):stdgo.time.Time.Duration throw "os._userTime is not yet implemented";
    /**
        // ExitCode returns the exit code of the exited process, or -1
        // if the process hasn't exited or was terminated by a signal.
    **/
    @:keep
    static public function exitCode( _p:Ref<ProcessState>):GoInt throw "os.exitCode is not yet implemented";
    @:keep
    static public function string( _p:Ref<ProcessState>):GoString throw "os.string is not yet implemented";
    @:keep
    static public function _sysUsage( _p:Ref<ProcessState>):AnyInterface throw "os._sysUsage is not yet implemented";
    @:keep
    static public function _sys( _p:Ref<ProcessState>):AnyInterface throw "os._sys is not yet implemented";
    @:keep
    static public function _success( _p:Ref<ProcessState>):Bool throw "os._success is not yet implemented";
    @:keep
    static public function _exited( _p:Ref<ProcessState>):Bool throw "os._exited is not yet implemented";
    /**
        // Pid returns the process id of the exited process.
    **/
    @:keep
    static public function pid( _p:Ref<ProcessState>):GoInt throw "os.pid is not yet implemented";
    /**
        // SysUsage returns system-dependent resource usage information about
        // the exited process. Convert it to the appropriate underlying
        // type, such as *syscall.Rusage on Unix, to access its contents.
    ...
    **/
    @:keep
    static public function sysUsage( _p:Ref<ProcessState>):AnyInterface throw "os.sysUsage is not yet implemented";
    /**
        // Sys returns system-dependent exit information about
        // the process. Convert it to the appropriate underlying
        // type, such as syscall.WaitStatus on Unix, to access its contents.
    **/
    @:keep
    static public function sys( _p:Ref<ProcessState>):AnyInterface throw "os.sys is not yet implemented";
    /**
        // Success reports whether the program exited successfully,
        // such as with exit status 0 on Unix.
    **/
    @:keep
    static public function success( _p:Ref<ProcessState>):Bool throw "os.success is not yet implemented";
    /**
        // Exited reports whether the program has exited.
        // On Unix systems this reports true if the program exited due to calling exit,
        // but false if the program terminated due to a signal.
    **/
    @:keep
    static public function exited( _p:Ref<ProcessState>):Bool throw "os.exited is not yet implemented";
    /**
        // SystemTime returns the system CPU time of the exited process and its children.
    **/
    @:keep
    static public function systemTime( _p:Ref<ProcessState>):stdgo.time.Time.Duration throw "os.systemTime is not yet implemented";
    /**
        // UserTime returns the user CPU time of the exited process and its children.
    **/
    @:keep
    static public function userTime( _p:Ref<ProcessState>):stdgo.time.Time.Duration throw "os.userTime is not yet implemented";
}
...
@:keep @:allow(stdgo.os.Os.LinkError_asInterface) class LinkError_static_extension {
    @:keep
    static public function unwrap( _e:Ref<LinkError>):Error throw "os.unwrap is not yet implemented";
    @:keep
    static public function error( _e:Ref<LinkError>):GoString throw "os.error is not yet implemented";
}
...
@:keep @:allow(stdgo.os.Os.T_onlyWriter_asInterface) class T_onlyWriter_static_extension {
    @:embedded
    public static function write( __self__:T_onlyWriter, _b:Slice<GoUInt8>):{ var _0 : GoInt; var _1 : Error; } return __self__.write(_b);
}
...
@:keep @:allow(stdgo.os.Os.T_file_asInterface) class T_file_static_extension {
    @:keep
    static public function _close( _file:Ref<T_file>):Error throw "os._close is not yet implemented";
}
...
@:keep @:allow(stdgo.os.Os.T_unixDirent_asInterface) class T_unixDirent_static_extension {
    @:keep
    static public function info( _d:Ref<T_unixDirent>):{ var _0 : FileInfo; var _1 : Error; } throw "os.info is not yet implemented";
    @:keep
    static public function type( _d:Ref<T_unixDirent>):FileMode throw "os.type is not yet implemented";
    @:keep
    static public function isDir( _d:Ref<T_unixDirent>):Bool throw "os.isDir is not yet implemented";
    @:keep
    static public function name( _d:Ref<T_unixDirent>):GoString throw "os.name is not yet implemented";
}
...
@:keep @:allow(stdgo.os.Os.T_rawConn_asInterface) class T_rawConn_static_extension {
    @:keep
    static public function write( _c:Ref<T_rawConn>, _f:GoUIntptr -> Bool):Error throw "os.write is not yet implemented";
    @:keep
    static public function read( _c:Ref<T_rawConn>, _f:GoUIntptr -> Bool):Error throw "os.read is not yet implemented";
    @:keep
    static public function control( _c:Ref<T_rawConn>, _f:GoUIntptr -> Void):Error throw "os.control is not yet implemented";
}
...
@:keep @:allow(stdgo.os.Os.File_asInterface) class File_static_extension {
    ...
    **/
    @:keep
    static public function stat( _f:Ref<File>):{ var _0 : FileInfo; var _1 : Error; } throw "os.stat is not yet implemented";
    @:keep
    static public function _readFrom( _f:Ref<File>, _r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Bool; var _2 : Error; } throw "os._readFrom is not yet implemented";
    /**
        // seek sets the offset for the next Read or Write on file to offset, interpreted
        // according to whence: 0 means relative to the origin of the file, 1 means
        // relative to the current offset, and 2 means relative to the end.
    ...
    **/
    @:keep
    static public function _seek( _f:Ref<File>, _offset:GoInt64, _whence:GoInt):{ var _0 : GoInt64; var _1 : Error; } throw "os._seek is not yet implemented";
    /**
        // Fd returns the integer Unix file descriptor referencing the open file.
        // If f is closed, the file descriptor becomes invalid.
        // If f is garbage collected, a finalizer may close the file descriptor,
    ...
    **/
    @:keep
    static public function fd( _f:Ref<File>):GoUIntptr throw "os.fd is not yet implemented";
    /**
        // checkValid checks whether f is valid for use.
        // If not, it returns an appropriate error, perhaps incorporating the operation name op.
    **/
    @:keep
    static public function _checkValid( _f:Ref<File>, _op:GoString):Error throw "os._checkValid is not yet implemented";
    /**
        // setWriteDeadline sets the write deadline.
    **/
    @:keep
    static public function _setWriteDeadline( _f:Ref<File>, _t:stdgo.time.Time.Time):Error throw "os._setWriteDeadline is not yet implemented";
    /**
        // setReadDeadline sets the read deadline.
    **/
    @:keep
    static public function _setReadDeadline( _f:Ref<File>, _t:stdgo.time.Time.Time):Error throw "os._setReadDeadline is not yet implemented";
    /**
        // setDeadline sets the read and write deadline.
    **/
    @:keep
    static public function _setDeadline( _f:Ref<File>, _t:stdgo.time.Time.Time):Error throw "os._setDeadline is not yet implemented";
    /**
        // Chdir changes the current working directory to the file,
        // which must be a directory.
        // If there is an error, it will be of type *PathError.
    **/
    @:keep
    static public function chdir( _f:Ref<File>):Error throw "os.chdir is not yet implemented";
    /**
        // Sync commits the current contents of the file to stable storage.
        // Typically, this means flushing the file system's in-memory copy
        // of recently written data to disk.
    **/
    @:keep
    static public function sync( _f:Ref<File>):Error throw "os.sync is not yet implemented";
    /**
        // Truncate changes the size of the file.
        // It does not change the I/O offset.
        // If there is an error, it will be of type *PathError.
    **/
    @:keep
    static public function truncate( _f:Ref<File>, _size:GoInt64):Error throw "os.truncate is not yet implemented";
    /**
        // Chown changes the numeric uid and gid of the named file.
        // If there is an error, it will be of type *PathError.
        //
    ...
    **/
    @:keep
    static public function chown( _f:Ref<File>, _uid:GoInt, _gid:GoInt):Error throw "os.chown is not yet implemented";
    /**
        // See docs in file.go:(*File).Chmod.
    **/
    @:keep
    static public function _chmod( _f:Ref<File>, _mode:FileMode):Error throw "os._chmod is not yet implemented";
    /**
        // pwrite writes len(b) bytes to the File starting at byte offset off.
        // It returns the number of bytes written and an error, if any.
    **/
    @:keep
    static public function _pwrite( _f:Ref<File>, _b:Slice<GoByte>, _off:GoInt64):{ var _0 : GoInt; var _1 : Error; } throw "os._pwrite is not yet implemented";
    /**
        // write writes len(b) bytes to the File.
        // It returns the number of bytes written and an error, if any.
    **/
    @:keep
    static public function _write( _f:Ref<File>, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "os._write is not yet implemented";
    /**
        // pread reads len(b) bytes from the File starting at byte offset off.
        // It returns the number of bytes read and the error, if any.
        // EOF is signaled by a zero count with err set to nil.
    **/
    @:keep
    static public function _pread( _f:Ref<File>, _b:Slice<GoByte>, _off:GoInt64):{ var _0 : GoInt; var _1 : Error; } throw "os._pread is not yet implemented";
    /**
        // read reads up to len(b) bytes from the File.
        // It returns the number of bytes read and an error, if any.
    **/
    @:keep
    static public function _read( _f:Ref<File>, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "os._read is not yet implemented";
    /**
        // Close closes the File, rendering it unusable for I/O.
        // On files that support SetDeadline, any pending I/O operations will
        // be canceled and return immediately with an ErrClosed error.
    ...
    **/
    @:keep
    static public function close( _f:Ref<File>):Error throw "os.close is not yet implemented";
    /**
        // SyscallConn returns a raw file.
        // This implements the syscall.Conn interface.
    **/
    @:keep
    static public function syscallConn( _f:Ref<File>):{ var _0 : stdgo.syscall.Syscall.RawConn; var _1 : Error; } throw "os.syscallConn is not yet implemented";
    /**
        // SetWriteDeadline sets the deadline for any future Write calls and any
        // currently-blocked Write call.
        // Even if Write times out, it may return n > 0, indicating that
    ...
    **/
    @:keep
    static public function setWriteDeadline( _f:Ref<File>, _t:stdgo.time.Time.Time):Error throw "os.setWriteDeadline is not yet implemented";
    /**
        // SetReadDeadline sets the deadline for future Read calls and any
        // currently-blocked Read call.
        // A zero value for t means Read will not time out.
    ...
    **/
    @:keep
    static public function setReadDeadline( _f:Ref<File>, _t:stdgo.time.Time.Time):Error throw "os.setReadDeadline is not yet implemented";
    /**
        // SetDeadline sets the read and write deadlines for a File.
        // It is equivalent to calling both SetReadDeadline and SetWriteDeadline.
        //
    ...
    **/
    @:keep
    static public function setDeadline( _f:Ref<File>, _t:stdgo.time.Time.Time):Error throw "os.setDeadline is not yet implemented";
    /**
        // Chmod changes the mode of the file to mode.
        // If there is an error, it will be of type *PathError.
    **/
    @:keep
    static public function chmod( _f:Ref<File>, _mode:FileMode):Error throw "os.chmod is not yet implemented";
    /**
        // wrapErr wraps an error that occurred during an operation on an open file.
        // It passes io.EOF through unchanged, otherwise converts
        // poll.ErrFileClosing to ErrClosed and wraps the error in a PathError.
    **/
    @:keep
    static public function _wrapErr( _f:Ref<File>, _op:GoString, _err:Error):Error throw "os._wrapErr is not yet implemented";
    /**
        // WriteString is like Write, but writes the contents of string s rather than
        // a slice of bytes.
    **/
    @:keep
    static public function writeString( _f:Ref<File>, _s:GoString):{ var _0 : GoInt; var _1 : Error; } return _f.write(_s);
    /**
        // Seek sets the offset for the next Read or Write on file to offset, interpreted
        // according to whence: 0 means relative to the origin of the file, 1 means
        // relative to the current offset, and 2 means relative to the end.
    ...
    **/
    @:keep
    static public function seek( _f:Ref<File>, _offset:GoInt64, _whence:GoInt):{ var _0 : GoInt64; var _1 : Error; } throw "os.seek is not yet implemented";
    /**
        // WriteAt writes len(b) bytes to the File starting at byte offset off.
        // It returns the number of bytes written and an error, if any.
        // WriteAt returns a non-nil error when n != len(b).
    ...
    **/
    @:keep
    static public function writeAt( _f:Ref<File>, _b:Slice<GoByte>, _off:GoInt64):{ var _0 : GoInt; var _1 : Error; } throw "os.writeAt is not yet implemented";
    /**
        // Write writes len(b) bytes from b to the File.
        // It returns the number of bytes written and an error, if any.
        // Write returns a non-nil error when n != len(b).
    ...
    **/
    @:keep
    static public function readFrom( _f:Ref<File>, _r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } throw "os.readFrom is not yet implemented";
    /**
        // ReadAt reads len(b) bytes from the File starting at byte offset off.
        // It returns the number of bytes read and the error, if any.
        // ReadAt always returns a non-nil error when n < len(b).
    ...
    **/
    @:keep
    static public function readAt( _f:Ref<File>, _b:Slice<GoByte>, _off:GoInt64):{ var _0 : GoInt; var _1 : Error; } throw "os.readAt is not yet implemented";
    /**
        // Read reads up to len(b) bytes from the File and stores them in b.
        // It returns the number of bytes read and any error encountered.
        // At end of file, Read returns 0, io.EOF.
    **/
    @:keep
    static public function read( _f:Ref<File>, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "os.read is not yet implemented";
    /**
        // Name returns the name of the file as presented to Open.
    **/
    @:keep
    static public function name( _f:Ref<File>):GoString throw "os.name is not yet implemented";
    @:keep
    static public function _readdir( _f:Ref<File>, _n:GoInt, _mode:T_readdirMode):{ var _0 : Slice<GoString>; var _1 : Slice<DirEntry>; var _2 : Slice<FileInfo>; var _3 : Error; } throw "os._readdir is not yet implemented";
    /**
        // ReadDir reads the contents of the directory associated with the file f
        // and returns a slice of DirEntry values in directory order.
        // Subsequent calls on the same file will yield later DirEntry records in the directory.
    ...
    **/
    @:keep
    static public function readDir( _f:Ref<File>, _n:GoInt):{ var _0 : Slice<DirEntry>; var _1 : Error; } throw "os.readDir is not yet implemented";
    /**
        // Readdirnames reads the contents of the directory associated with file
        // and returns a slice of up to n names of files in the directory,
        // in directory order. Subsequent calls on the same file will yield
    ...
    **/
    @:keep
    static public function readdirnames( _f:Ref<File>, _n:GoInt):{ var _0 : Slice<GoString>; var _1 : Error; } throw "os.readdirnames is not yet implemented";
    /**
        // Readdir reads the contents of the directory associated with file and
        // returns a slice of up to n FileInfo values, as would be returned
        // by Lstat, in directory order. Subsequent calls on the same file will yield
    ...
    **/
    @:keep
    static public function readdir( _f:Ref<File>, _n:GoInt):{ var _0 : Slice<FileInfo>; var _1 : Error; } throw "os.readdir is not yet implemented";
    @:embedded
    public static function _close( __self__:File):Error return __self__._close();
}
...
@:keep @:allow(stdgo.os.Os.T_fileStat_asInterface) class T_fileStat_static_extension {
    @:keep
    static public function sys( _fs:Ref<T_fileStat>):AnyInterface throw "os.sys is not yet implemented";
    @:keep
    static public function modTime( _fs:Ref<T_fileStat>):stdgo.time.Time.Time throw "os.modTime is not yet implemented";
    @:keep
    static public function mode( _fs:Ref<T_fileStat>):FileMode throw "os.mode is not yet implemented";
    @:keep
    static public function size( _fs:Ref<T_fileStat>):GoInt64 throw "os.size is not yet implemented";
    @:keep
    static public function isDir( _fs:Ref<T_fileStat>):Bool throw "os.isDir is not yet implemented";
    @:keep
    static public function name( _fs:Ref<T_fileStat>):GoString throw "os.name is not yet implemented";
}
...
@:keep @:allow(stdgo.os.Os.T_dirFS_asInterface) class T_dirFS_static_extension {
    ...
    **/
    @:keep
    static public function _join( _dir:T_dirFS, _name:GoString):{ var _0 : GoString; var _1 : Error; } throw "os._join is not yet implemented";
    @:keep
